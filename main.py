...
root.set_theme("arc")
statusbar = ttk.Label(
    root, text="Music Player", anchor=W, foreground="red", font="Arial 12 bold italic"
)
...
rtframe = Frame(root, bg="white")
rtframe.pack(pady=30, padx=20)
topframe = Frame(rtframe, bg="white")
topframe.pack()
root.style = ttk.Style()
# root.style.theme_use("clam")
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror(
                "File not found",
                "music player could not find the file. Please select again.",
            )
...
middleframe = Frame(rtframe, bg="white")
